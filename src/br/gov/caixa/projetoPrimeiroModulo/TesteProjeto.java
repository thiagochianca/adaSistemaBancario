...
public class TesteProjeto {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Conta Corrente aberta para: " + cliente1.getNome());

        ContaPoupanca poupa = cliente1.abrirContaPoupanca(2, 0, true);
        System.out.println("Conta Poupança aberta para: " + cliente1.getNome());

        ContaInvestimento bitcoin = cliente1.abrirContaInvestimento(3, 0, true);
        System.out.println("Conta Investimento aberta para: " + cliente1.getNome() + "\n");
        ...
        if (bitcoin.gerarRendimentoInvestimento()) {
        ...
        System.out.println("Conta Corrente aberta para: " + cliente2.getNome() + "\n");
